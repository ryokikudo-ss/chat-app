...
public class RoomController {
  ...
  public String showRoomForm(@AuthenticationPrincipal CustomUserDetail currentUser, Model model) {
  ...
  @PostMapping("/rooms")
    public String createRoom(@ModelAttribute ("RoomForm") RoomForm roomForm, @AuthenticationPrincipal CustomUserDetail currentUser, Model model, BindingResult bindingResult) {
      ...
      List<Long> memberIds = roomForm.getMemberIds();
