...
public class MessageController {
  ...
  /*@GetMapping("/")
  public String showMessage(@AuthenticationPrincipal CustomUserDetail currentUser, Model model) {
  ...
  @GetMapping("/message")
  public String showMessage(@AuthenticationPrincipal CustomUserDetail currentUser, Model model, @RequestParam("roomId") Integer roomId) {
    UserEntity user = userRepository.findById(currentUser.getId());
    model.addAttribute("user", user);
    List<RoomUserEntity> roomUserEntities = roomUserRepository.findByUserId(currentUser.getId());
    List<RoomEntity> roomList = roomUserEntities.stream()
